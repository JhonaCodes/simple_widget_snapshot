...
class WidgetSnapshot {
  ...
  static Future<SnapshotResult> capture(
    GlobalKey key, {
    double pixelRatio = 1.0,
    Duration delay = const Duration(milliseconds: 20),
  }) async {
    ui.Image? image =
        await _captureWidget(key, pixelRatio: pixelRatio, delay: delay);
...
class SnapshotResult {
  ...
  SnapshotResult(
      {this.byteData, this.uint8list, this.imageFromMemory, this.bytesImage});
}
